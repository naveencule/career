import 'dart:convert';
import 'package:career_guidance/career.dart';
...
class FileUploadScreen2 extends StatelessWidget {
  @override
                ...
                children: <Widget>[
                  ...
                  ElevatedButton(
                    onPressed: () async {
                      ...
                      print("+++++++___________________" + url + "upldcv");
                      var data = await http.post(Uri.parse(url + "upldcv"), body: {
                        'file': base64Image,
                        // 'lid': lid,
                        // 'vid': jid,
                      });
                      ...
                      sh.setString("career", jasondata['res'].toString());
