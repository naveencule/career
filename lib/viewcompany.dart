...
class viewcompanypagePage extends StatefulWidget {
  const viewcompanypagePage({super.key, required this.title});
  ...
  @override
  State<viewcompanypagePage> createState() => _viewcompanypagePage();
}

class _viewcompanypagePage extends State<viewcompanypagePage> {
  // int _counter = 0;

  _viewcompanypagePage() {
    view_college();
  }
